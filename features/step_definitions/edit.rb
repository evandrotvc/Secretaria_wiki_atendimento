...
Dado("que acesso o banco e tem-se  informações disponíveis") do
    visit 'http://localhost:3000/attendances/97/edit' # entra na pagina de edicao do primeiro registro
  end
  ...
  Dado("que conecta-se ao banco") do
    visit 'http://localhost:3000/attendances/98/edit' # entra na pagina de edicao do segundo registro
  end
  ...
  Dado("que um registro é acessado para inclusão de comentários") do
    visit 'http://localhost:3000/attendances/97' # entra na pagina de Mostrar detalhes do primeiro registro
  end
